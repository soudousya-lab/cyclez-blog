...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/select`, lastModified: new Date('2026-07-19'), changeFrequency: 'monthly' as const, priority: 0.9 },
    { url: `${BASE_URL}/bikes`, lastModified: new Date('2026-07-19'), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${BASE_URL}/cyclewear`, lastModified: new Date('2026-07-19'), changeFrequency: 'monthly' as const, priority: 0.8 },
