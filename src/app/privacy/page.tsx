      ...
      <div className="bg-gradient-to-r from-[#c41e3a] to-[#e85a70] text-white py-12">
        <div className="max-w-4xl mx-auto px-4">
          <nav className="flex items-center gap-2 text-sm text-white/80 mb-6">
            ...
            <span>/</span>
            <span className="text-white">個人情報保護方針</span>
          </nav>
          <p className="text-white/80 text-sm mb-2">PRIVACY POLICY</p>
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold">プライバシーポリシー</h1>
        </div>
      </div>
