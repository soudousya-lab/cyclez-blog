    ...
    >
      ...
      >
        ...
        <svg
          ...
          aria-hidden="true"
        >
          <path d="M24 10.304c0-5.369-5.383-9.738-12-9.738S0 4.935 0 10.304c0 4.813 4.269 8.846 10.036 9.608.39.084.923.258 1.058.592.121.303.079.777.039 1.085l-.171 1.027c-.053.303-.242 1.186 1.039.647 1.281-.54 6.911-4.069 9.428-6.967C23.268 14.392 24 12.458 24 10.304zm-16.86 3.143H5.503a.483.483 0 01-.483-.483V8.831a.483.483 0 01.966 0v3.65h1.154a.483.483 0 010 .966zm2.122-.483a.483.483 0 01-.966 0V8.831a.483.483 0 01.966 0v4.133zm4.56 0a.483.483 0 01-.85.313l-2.246-3.063v2.75a.483.483 0 01-.966 0V8.831a.483.483 0 01.85-.313l2.246 3.063V8.831a.483.483 0 01.966 0v4.133zm3.882-3.167a.483.483 0 010 .966h-1.154v.717h1.154a.483.483 0 010 .966h-1.637a.483.483 0 01-.483-.483V8.831c0-.267.216-.483.483-.483h1.637a.483.483 0 010 .966h-1.154v.717h1.154a.483.483 0 010 .966z" />
        </svg>
      </a>
    </div>
  );
