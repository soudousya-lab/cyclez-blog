        ...
        <div className="max-w-6xl mx-auto px-2 sm:px-4">
          <div className="flex justify-between items-center h-14 sm:h-16 md:h-20 lg:h-24">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/cyclez2015/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center">
      ...
      <nav className="hidden md:block border-b border-gray-200 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <ul className="flex justify-center gap-0">
            ...
            <li>
              <Link href="/about/staff" className="block px-5 py-4 text-sm text-gray-700 hover:text-[#c41e3a] hover:bg-gray-50 transition-colors border-b-2 border-transparent hover:border-[#c41e3a]">
                スタッフ紹介
              </Link>
            </li>
            <li>
